@if (isset($slider))
    {!! Form::model($slider, ['url' => 'slider-three-auth/'.$slider->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'slider-three-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
