@if (isset($slider))
    {!! Form::model($slider, ['url' => 'slider-two-auth/'.$slider->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'slider-two-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
