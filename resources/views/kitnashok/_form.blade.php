@if (isset($kitnashok))
    {!! Form::model($kitnashok, ['url' => 'kitnashok-auth/'.$kitnashok->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'kitnashok-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
...
<div class="form-group" {{ $errors->has('description') ? 'has error' : '' }}>
    ...
    <div class="col-sm-9">
        {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'ব্যাখ্য', 'autocomplete' => 'off', 'rows' => 4, 'required']) !!}
        <span class="help-block text-danger">
