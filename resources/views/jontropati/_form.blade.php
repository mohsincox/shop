@if (isset($jontropati))
    {!! Form::model($jontropati, ['url' => 'jontropati-auth/'.$jontropati->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'jontropati-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
