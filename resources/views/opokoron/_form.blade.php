@if (isset($opokoron))
    {!! Form::model($opokoron, ['url' => 'opokoron-auth/'.$opokoron->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'opokoron-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
