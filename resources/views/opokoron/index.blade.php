...
@section('content')
    <div class="container">
        <h2>উপকরণ</h2>
        <a href="{{ url("opokoron-auth/create") }}" class="btn btn-primary pull-right">
        ...
        <div>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{{ Html::link("opokoron-auth/$bij->id/edit", ' Edit', ['class' => 'fa fa-edit btn btn-primary btn-xs']) }}</td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{ Form::open(['method' => 'DELETE', 'url' => "opokoron-auth/$bij->id"]) }}
