...
@if(isset($kitnashok))
    <div style="text-align: left">
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <p>{!!  '<strong>Name: </strong>'. $kitnashok->name  !!}</p>
                <p>{!!  '<strong>Code: </strong>'. $kitnashok->code  !!}</p>
                <p>{!!  '<strong>Price: </strong>'. $kitnashok->price  !!}</p>
            </div>

        </div>
        <div class="col-sm-12">
            {!!  '<strong>Description: </strong>'. $kitnashok->description  !!}
        </div>
    </div>
@endif
