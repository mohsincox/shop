@if (isset($khaddo))
    {!! Form::model($khaddo, ['url' => 'posho-pakhir-khaddo-auth/'.$khaddo->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'posho-pakhir-khaddo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
