...
@section('content')
    <div class="container">
        ...
        <h2>Posho Pakhir Khaddo
            <a href="{{ url("posho-pakhir-khaddo-auth/create") }}" class="btn btn-primary pull-right">
        ...
        <div>
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{ Html::link("posho-pakhir-khaddo-auth/$khaddo->id/edit", ' Edit', ['class' => 'fa fa-edit btn btn-primary btn-xs']) }}</td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{ Form::open(['method' => 'DELETE', 'url' => "posho-pakhir-khaddo-auth/$khaddo->id"]) }}
