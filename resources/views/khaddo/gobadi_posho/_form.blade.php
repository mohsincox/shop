@if (isset($khaddo))
    {!! Form::model($khaddo, ['url' => 'gobadi-poshor-khaddo-auth/'.$khaddo->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'gobadi-poshor-khaddo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
