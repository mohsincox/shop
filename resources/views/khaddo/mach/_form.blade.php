@if (isset($khaddo))
    {!! Form::model($khaddo, ['url' => 'macher-khaddo-auth/'.$khaddo->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'macher-khaddo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
