@if (isset($khaddo))
    {!! Form::model($khaddo, ['url' => 'krishi-khaddo-auth/'.$khaddo->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'krishi-khaddo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
