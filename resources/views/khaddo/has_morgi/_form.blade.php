@if (isset($khaddo))
    {!! Form::model($khaddo, ['url' => 'has-morgir-khaddo-auth/'.$khaddo->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'has-morgir-khaddo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
