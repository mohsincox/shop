@if (isset($osodh))
    {!! Form::model($osodh, ['url' => 'motso-osodh-auth/'.$osodh->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'motso-osodh-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
