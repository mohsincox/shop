@if (isset($osodh))
    {!! Form::model($osodh, ['url' => 'has-morgir-osodh-auth/'.$osodh->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'has-morgir-osodh-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
