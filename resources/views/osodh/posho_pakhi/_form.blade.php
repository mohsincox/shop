@if (isset($osodh))
    {!! Form::model($osodh, ['url' => 'posho-pakhir-osodh-auth/'.$osodh->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'posho-pakhir-osodh-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
