@if (isset($osodh))
    {!! Form::model($osodh, ['url' => 'gobadi-poshor-osodh-auth/'.$osodh->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'gobadi-poshor-osodh-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
