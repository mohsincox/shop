@if (isset($postika))
    {!! Form::model($postika, ['url' => 'postika-auth/'.$postika->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'postika-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
