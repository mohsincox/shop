@if (isset($food))
    {!! Form::model($food, ['url' => 'organic-vegetables-auth/'.$food->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'organic-vegetables-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
