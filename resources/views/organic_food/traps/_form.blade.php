@if (isset($food))
    {!! Form::model($food, ['url' => 'bio-pesticides-and-traps-auth/'.$food->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'bio-pesticides-and-traps-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
