@if (isset($food))
    {!! Form::model($food, ['url' => 'organic-farming-auth/'.$food->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'organic-farming-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
