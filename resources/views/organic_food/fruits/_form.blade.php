@if (isset($food))
    {!! Form::model($food, ['url' => 'organic-fruits-auth/'.$food->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'organic-fruits-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
