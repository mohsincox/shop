@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'hosto-shilpo-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'hosto-shilpo-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
