@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'proyojon-onnanno-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'proyojon-onnanno-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
