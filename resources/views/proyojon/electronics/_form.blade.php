@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'electronics-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'electronics-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
