@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'telecom-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'telecom-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
