@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'lab-equipment-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'lab-equipment-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
