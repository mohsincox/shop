...
@section('content')
    <div class="container">
        ...
        <h2>Cosmetics
            <a href="{{ url("cosmetics-auth/create") }}" class="btn btn-primary pull-right">
        ...
        <div>
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{ Html::link("cosmetics-auth/$proyojon->id/edit", ' Edit', ['class' => 'fa fa-edit btn btn-primary btn-xs']) }}</td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{ Form::open(['method' => 'DELETE', 'url' => "cosmetics-auth/$proyojon->id"]) }}
