@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'cosmetics-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'cosmetics-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
