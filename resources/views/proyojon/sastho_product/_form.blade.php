@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'sastho-product-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'sastho-product-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
