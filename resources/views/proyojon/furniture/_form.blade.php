@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'furniture-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'furniture-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
