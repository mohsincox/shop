@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'crockeries-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'crockeries-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
