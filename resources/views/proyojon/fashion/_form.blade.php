@if (isset($proyojon))
    {!! Form::model($proyojon, ['url' => 'fashion-auth/'.$proyojon->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'fashion-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
