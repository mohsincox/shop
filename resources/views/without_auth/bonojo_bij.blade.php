...
<div class="section-home our-causes fadeIn">
    ...
    <div class="container">
        ...
        <h2 class="title-style-1" style="margin-top: 110px;">বনজ বীজ <span class="title-under"></span></h2>

        <div class="row">
            @foreach($bonojoBijs as $key=>$fulBij)
                <div class="col-md-2 col-sm-6">
                    ...
                    <div class="cause fbbox">
                        ...
                        <div class="btn-holder text-center">
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#donateModal" id="bonojo-bij" value="{{ $fulBij->id }}"><strong>বিস্তারিত</strong></button>
