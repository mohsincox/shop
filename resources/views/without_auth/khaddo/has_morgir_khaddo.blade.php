...
<div class="section-home our-causes fadeIn">
    ...
    <div class="container">
        ...
        <h2 class="title-style-1" style="margin-top: 110px;">হাঁস-মুরগীর খাদ্য <span class="title-under"></span></h2>

        <div class="row">
            @foreach($hasMorgirKhaddos as $key=>$macherKhaddo)
                <div class="col-md-2 col-sm-6">
                    ...
                    <div class="cause fbbox">
                        ...
                        <div class="btn-holder text-center">
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#donateModal" id="has-morgir-khaddo" value="{{ $macherKhaddo->id }}"><strong>বিস্তারিত</strong></button>
