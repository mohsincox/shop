@if (isset($osodhiBij))
    {!! Form::model($osodhiBij, ['url' => 'osodhi-bij-auth/'.$osodhiBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'osodhi-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
