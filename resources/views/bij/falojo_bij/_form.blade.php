@if (isset($falojoBij))
    {!! Form::model($falojoBij, ['url' => 'falojo-bij-auth/'.$falojoBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'falojo-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
