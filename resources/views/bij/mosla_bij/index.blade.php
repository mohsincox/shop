...
@section('content')
    <div class="container">
        ...
        <h2>mosla bij
            <a href="{{ url("mosla-bij-auth/create") }}" class="btn btn-primary pull-right">
        ...
        <div>
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{ Html::link("mosla-bij-auth/$bij->id/edit", ' Edit', ['class' => 'fa fa-edit btn btn-primary btn-xs']) }}</td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{ Form::open(['method' => 'DELETE', 'url' => "mosla-bij-auth/$bij->id"]) }}
