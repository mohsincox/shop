@if (isset($moslaBij))
    {!! Form::model($moslaBij, ['url' => 'mosla-bij-auth/'.$moslaBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'mosla-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
