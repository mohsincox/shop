@if (isset($tontoBij))
    {!! Form::model($tontoBij, ['url' => 'tonto-bij-auth/'.$tontoBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'tonto-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
