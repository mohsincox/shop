@if (isset($bonojoBij))
    {!! Form::model($bonojoBij, ['url' => 'bonojo-bij-auth/'.$bonojoBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'bonojo-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
