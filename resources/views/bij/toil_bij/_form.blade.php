@if (isset($toilBij))
    {!! Form::model($toilBij, ['url' => 'toil-bij-auth/'.$toilBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'toil-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
