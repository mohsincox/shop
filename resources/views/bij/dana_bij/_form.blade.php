@if (isset($danaBij))
    {!! Form::model($danaBij, ['url' => 'dana-bij-auth/'.$danaBij->id, 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
@else
    {!! Form::open(['url' => 'dana-bij-auth', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
@endif
